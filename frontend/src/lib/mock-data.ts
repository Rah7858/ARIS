...
export interface Camera {
  ...
  lat: number;
  lng: number;
  status: "ONLINE" | "OFFLINE" | "MAINTENANCE" | "online" | "offline";
  resolution: string;
...
export const cameras: Camera[] = [
  { id: "CAM-001", name: "Western Express Hwy", city: "Mumbai",    location: "Bandra Junction",     lat: 19.0596, lng: 72.8295, status: "online", resolution: "4K",    uptime: 99.8, videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4", streamUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4" },
  { id: "CAM-002", name: "Ring Road North",     city: "Delhi",     location: "Connaught Place",     lat: 28.6315, lng: 77.2167, status: "online", resolution: "4K",    uptime: 99.2, videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4", streamUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4" },
  { id: "CAM-003", name: "Outer Ring Road",     city: "Bangalore", location: "Marathahalli Bridge", lat: 12.9591, lng: 77.6974, status: "online", resolution: "1080p", uptime: 98.5, videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4", streamUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4" },
  { id: "CAM-004", name: "OMR Corridor",        city: "Chennai",   location: "Sholinganallur",      lat: 12.9010, lng: 80.2279, status: "online", resolution: "4K",    uptime: 97.1, videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4", streamUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4" },
  { id: "CAM-005", name: "Mumbai Expressway",    city: "Pune",      location: "Lonavla Exit",        lat: 18.7546, lng: 73.4062, status: "online", resolution: "4K",    uptime: 95.3, videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4", streamUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerMeltdowns.mp4" },
  { id: "CAM-006", name: "OUTER Ring Road",     city: "Hyderabad", location: "Gachibowli Junction",  lat: 17.3850, lng: 78.4867, status: "online", resolution: "4K",    uptime: 96.7, videoUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4", streamUrl: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/SubaruOutbackOnStreetAndDirt.mp4" },
];
